...
import { FlaskConical, HelpCircle, ScanSearch, ListChecks, Info } from "lucide-react";
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-3xl font-bold flex items-center gap-2">
              ...
              <span>AI Food Analysis Center</span>
              <Tooltip>
                ...
                <TooltipContent side="right" className="max-w-xs">
                  ...
                  <ul className="list-disc list-inside text-sm space-y-1">
                    <li>Analyze ingredient lists for health insights.</li>
                    <li>Analyze product names for common ingredients.</li>
                    <li>Get detailed AI reports (effects, FSSAI, etc.).</li>
                    <li>Summarize analyses into concise points.</li>
                  </ul>
                </TooltipContent>
              </Tooltip>
            </CardTitle>
